...
const blogs: BlogProps[] = [
  {
    slug: '/blog/single',
    image: {
      src: '/assets/images/blog/blog-lg-1.jpg',
      alt: '24/7 Pool monitoring Service ',
    },
    authorName: 'admin',
    category: 'Category',
    commentCount: '05',
  ...
  },
  {
    slug: '/blog/single',
    image: {
      src: '/assets/images/blog/blog-lg-2.jpg',
      alt: 'Water balance and Water chemistry',
    },
    authorName: 'admin',
    category: 'Category',
    commentCount: '05',
    title: 'Water balance and Water chemistry',
    description: `Water balance refers to maintaining the right relationship between different chemical parameters so that the water doesn't become corrosive or scale-forming.
...
Low pH (acidic): Corrosive to equipment, irritates skin and eyes.

High pH (basic): Causes scaling, cloudy water, and reduces chlorine effectiveness.

Total Alkalinity (TA) (Ideal: 80 – 120 ppm)

Acts as a buffer to keep pH stable.

Low TA: pH fluctuates wildly (pH bounce).

High TA: Makes pH hard to adjust.

Calcium Hardness (Ideal: 200 – 400 ppm)

Measures calcium concentration in water.

Low: Water becomes corrosive (damages surfaces).

High: Causes scaling on surfaces and equipment.

Temperature

Warmer water increases evaporation, scaling potential, and affects chemical reactions.

Total Dissolved Solids (TDS) (Keep below 1500 ppm for most pools)

Includes all minerals, salts, and metals.

High TDS: Reduces effectiveness of sanitizers and affects water clarity.`,
  },
];
...
const authorData: AuthorProps = {
  ...
  name: 'Mr. Mo',
  about: 'CPO cerified Professional from PHTA.org',
  socialLinks: [
    {
      icon: <FaFacebookF />,
