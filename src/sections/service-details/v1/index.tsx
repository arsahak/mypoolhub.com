...
const services: LinkProps[] = [
  ...
  {
    label: 'Pool Maintenance serveice',
    href: '/',
  },
  {
    label: 'Pool cleaning with chemical Feed',
    href: '/',
  },
  /*
  {
      ...
      <Container>
        <div className="grid items-start gap-10 md:grid-cols-[390px_1fr] 2xl:gap-[50px]">
          ...
          <div className="grid gap-10 md:sticky md:top-[76px] lg:top-[133px] 2xl:gap-[60px]">
            ...
            >
              <Image
                //detail service picture
                src="/assets/images/project-details/blue_sky.JPG"
            ...
            <div className="grid gap-30px">
              <div className="relative z-1 bg-accent-100 p-10 dark:bg-accent-700">
                <p>
                  Your Pool, Done Right We are proud to offer service thats not
                  just professional, but reliable, responsible, and 100%
                  safety-focused. When you choose us, you are choosing peace of
                  mind—and thats something we will never compromise on. So go
                  ahead. Kick back. Enjoy your pool knowing it’s being cared for
                  by people who take safety as seriously as you take relaxation.
                </p>
              ...
              <div className="flex items-center gap-5">
                <Image
                  src={'/assets/images/service-details/blue_sky.JPG'}
                  width={66}
                  height={66}
                ...
                />
                <div>
                  <h3 className="h3 text-accent-700 dark:text-white">Mr. Mo</h3>
                  <p>Manager</p>
                </div>
              </div>
            </div>
          ...
          <div className="grid gap-6">
            <div className="relative mb-5 overflow-hidden rounded-5">
              <Image
                // main image for service
                src={'/assets/images/service-details/main-image-1.jpg'}
            ...
            <p>Always On. Always Safe.</p>

            <p>
              {` Our 24/7 Pool Monitoring Service offers around-the-clock surveillance and protection for your pool, ensuring safety, cleanliness, and peace of mind—day and night.
            Whether you're managing a residential, commercial, or community pool, our system combines smart technology and real-time alerts to proactively monitor for potential issues before they become costly problems.
           `}
            </p>
            <div className="my-10 grid items-center gap-8 md:grid-cols-2">
              ...
              <div className="grid gap-4">
                <div className="grid gap-3">
                  ...
                  <p>
                    Advanced camera systems with AI-powered motion detection
                    help ensure no unauthorized or unsafe activity goes
                    unnoticed.
                  </p>
                </div>
                <div className="grid gap-3">
                  ...
                  <p>
                    Constant tracking of chemical levels, temperature, and pH
                    ensures your pool stays balanced and swim-ready at all
                    times.
                  </p>
                </div>
              </div>
            ...
            <p>
              At MyPoolHub.com, we are not just about crystal-clear water and
              sparkly tiles (though we are great at that too). We are all about
              doing things right—and that means putting safety first, every
              single time
            </p>
            ...
            <div className="mt-2.5 grid grid-cols-[1fr_260px] gap-6">
              <div className="grid items-baseline gap-6 lg:gap-9">
                <div>
                  ...
                  <p>
                    From pumps and filters to heaters and lights, we monitor all
                    critical components and notify you of potential malfunctions
                    or inefficiencies.
                  </p>
                </div>
                <div>
                  ...
                  <p>
                    Integrated alert systems can notify emergency contacts or
                    local authorities instantly in case of an accident or
                    intrusion.
                  </p>
                </div>
                <div>
                  ...
                  <p>
                    Manage your pool from anywhere with a secure mobile app.
                    Receive instant alerts about abnormalities—whether it’s low
                    chlorine levels or unexpected after-hours usage.
                  </p>
                </div>
              </div>
              <Image
                src="/assets/images/service-details/image-3_new.PNG"
                alt="service image 2"
                width={640}
                height={870}
                className="rounded-5"
